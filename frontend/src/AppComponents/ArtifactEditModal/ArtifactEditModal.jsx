...
export default function ArtifactEditModal({
  ...
  return (
    ...
    >
      ...
      >
        <header
          className="artifact-edit-header"
        >
          <div
            className="artifact-edit-title-area"
          >
            <div
              className="artifact-edit-icon"
            >
              <EditDocumentIcon />
            </div>
            ...
            <div>
              <p
                className="artifact-edit-eyebrow"
              >
                Edit document
              </p>
              ...
              >
...

                {
                  artifact
                    .original_filename && (
                    <span
                      className="artifact-edit-filename"
                      title={
                        artifact
                          .original_filename
                      }
        ...
        <div
          className="artifact-edit-body"
        >
          <div
            className="artifact-edit-label-row"
          >
            <label
              htmlFor="artifact-content-editor"
            >
              Artifact content
            </label>
        ...
        <footer
          className="artifact-edit-footer"
        >
          <div
            className="artifact-edit-shortcut"
          >
            <span>
              Tip:
            </span>
          ...
          >
            ...
            >
              {isSaving ? (
                <>
                  <span
                    className="artifact-edit-spinner"
                  />
...
function EditDocumentIcon() {
  return (
    ...
    >
      ...
      <path
        d="M9 16.5L15.8 9.7L18.3 12.2L11.5 19H9Z"
      />
    </svg>
  );
}
